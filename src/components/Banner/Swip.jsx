    ...
    <div className="group ">
      ...
      >
        ...
        <div className="video-container  h-[4500px] md:h-[550px] bg-black duration-150 ease-in-out">
          <video src="/VIDEOS/1.mp4" className="w-full h-full" placeholder="blure"  loop autoPlay/>
        </div>
        </SwiperSlide>
        <SwiperSlide>
        <div className=" w-full h-[450px] md:h-[550px] bg-black transition duration-150 ease-in-out">
          <video src="/VIDEOS/2.mp4" className=" h-full " placeholder="blure"  loop autoPlay />
        </div>
        </SwiperSlide>
        <SwiperSlide>
        <div className=" w-full h-[450px] md:h-[550px] bg-black transition duration-150 ease-in-out">
          <video src="/VIDEOS/3.mp4" className=" h-full " placeholder="blure" loop autoPlay />
        </div>
        </SwiperSlide>
          <Arrow/>
          <button className=" absolute btn z-[200] top-[70%] left-[20%]  bg-[var(--color-default)] text-white font-bold px-4 py-2 text-lg rounded-md ">BUY NOW</button>
      </Swiper>
    </div>
  );
}